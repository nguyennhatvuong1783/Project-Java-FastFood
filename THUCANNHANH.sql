...
CREATE TABLE CHITIETQUYENTAIKHOAN(
	USERNAME VARCHAR(10),
	MAQUYEN VARCHAR(10),
	PRIMARY KEY (USERNAME, MAQUYEN),
)
...
ALTER TABLE CHITIETQUYEN ADD CONSTRAINT CTQ_MAQUYEN_FK FOREIGN KEY (MAQUYEN) REFERENCES QUYEN (MAQUYEN)

ALTER TABLE CHITIETQUYEN ADD CONSTRAINT CTQ_TENCN_FK FOREIGN KEY (MACN) REFERENCES CHUCNANG (MACN)

ALTER TABLE TAIKHOAN ADD CONSTRAINT USERNAME_FK FOREIGN KEY (USERNAME) REFERENCES NHANVIEN (MANV)

ALTER TABLE CHITIETQUYENTAIKHOAN ADD CONSTRAINT CTQTK_USERNAME_FK FOREIGN KEY (USERNAME) REFERENCES TAIKHOAN (USERNAME)

ALTER TABLE CHITIETQUYENTAIKHOAN ADD CONSTRAINT CTQTK_MAQUYEN_FK FOREIGN KEY (MAQUYEN) REFERENCES QUYEN (MAQUYEN)
...
VALUES
('Q1', N'Bán hàng'),
('Q2', N'Quản lý hóa đơn'),
('Q3', N'Nhập hàng'),
('Q4', N'Quản lý món ăn'),
('Q5', N'Quản lý nguyên liệu'),
('Q6', N'Quản lý nhân viên'),
('Q7', N'Quản lý khách hàng'),
('Q8', N'Quản lý nhà cung cấp'),
('Q9', N'Quản lý khuyến mãi'),
('Q10', N'Quản lý tài khoản'),
('Q11', N'Thống kê')
