...
public class KhuyenMaiBus {
    ...
    public int themKM() {
        ...
        if ((khuyenMaiGui.getTxt_TenKM().getText().equals(""))
            ...
            return 2;
        } else if ((khuyenMaiGui.getTxt_phanTram().getText().matches("[a-z0-9A-Z]{1,}[a-z0-9A-Z]{0,}") == false
                && khuyenMaiGui.getTxt_phanTram().getText().matches("[a-z0-9A-Z]{1,}.[a-z0-9A-Z]{0,}") == false)
    ...
    public void LoadThongTinKm() {
        ...
        khuyenMaiGui.getDate_BĐ().setEnabled(false);
    ...
    public int SuaKm() {
        ...
        if ((khuyenMaiGui.getTxt_TenKM().getText().equals(""))
            ...
            if (new Date().after(khuyenMaiGui.getDate_KT().getDate())) {
